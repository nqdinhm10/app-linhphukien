         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">   
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" min="0" name="productQuantity" value="<?php echo  $result_product['productQuantity']?>" class="medium" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <textarea name="product_desc" class="tinymce" rows="5" cols="77"><?php echo $result_product['product_desc'] ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <img src="uploads/<?php echo $result_product['image'] ?>" width="90"><br><br>
